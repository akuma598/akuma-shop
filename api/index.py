...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .modal-content{background:linear-gradient(135deg,#2e004d,#1a0033);border-radius:24px;padding:30px;text-align:center;border:2px solid #ffcc00;max-width:350px;}
...
<body>
    ...
    <script>
        ...
        function renderProducts() {
            ...
            container.innerHTML = html || '<div style="text-align:center;padding:20px;">Товары загружаются...</div>';
        }
